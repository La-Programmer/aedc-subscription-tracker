...
def get_subscriptions():
    ...
    for subscription in all_subscriptions:
        list_subscriptions.append(subscription.make_api_response())
...
def update_subscription(subscription_id):
    ...
    try:
        ...
        abort(500, description="Failed to update subscription")
    current_app.logger.critical(f"Subscription {subscription.subscription_name} has been updated")
    subscription_response = subscription.make_api_response()
